              ...
              <div class="col-sm-6"> <!-- information -->
                  <section class="panel">
                    ...
                    <header class="panel-heading">
                      <h2 class="box-title" style="text-transform:capitalize;"><b> detailed information</b></h2>
                    </header>
             ...
             for (var i in rows) 
              { 
                ...
                map.setZoom(18); 
                    ...
                    if(i==0){
                      $('#detgal').append("<tr><td>Name</td><td>:</td><td> "+name+"</td></tr><br><tr><td>Address</td><td>:</td><td> "+address+"</td></tr><br><tr><td>Telephone</td><td>:</td><td> "+cp+"</td></tr><br><tr><td>Owner</td><td>:</td><td> "+owner+"</td></tr><br><tr><td>Place's Status</td><td>:</td><td> "+status+"</td></tr><br><tr><td>Type</td><td>:</td><td> "+type+"</td></tr><tr><td><b> Product </b></td><td></td><td><b> Price </b></td></tr>");
                    }
