            ...
            <a href="?page=souvenir<?php echo $id ?>" class="btn btn-theme"><i class="fa fa-chevron-left"></i> Back</a>  </div>
              
    <div class="btn-group pull-right" style="width:90px;">
    <a href="?page=formprosouv" class="btn btn-theme">Add <i class="fa fa-plus"></i></a><br><br><br>
    </div>
    </div>
