...
while($row = pg_fetch_array($hasil)){
	...
	$lng=$row['lng'];
	if ($lat=='' || $lat==''){
		$lat='<span style="color:red">Null</span>';
		$lng='<span style="color:red">Null</span>';
	}
}
?>
<!-- Default box -->
    ...
    <table>
		...
		<table class="table table-hover table-bordered table-striped">
			<thead><th>Souvenir's Product</th><th>Price</th></thead>
			<tbody>													
			<?php 
			...
			<a href="?page=forml&id=<?php echo $id ?>" class="btn btn-round btn-warning"><i class="fa fa-edit"></i> Set Product</a>
				...
				<br><tr><td>
                    ...
                    ?>
                    <table class="table">
                    	<thead><th>Date</th><th class="centered">Information</th><th>Action</th></thead>
                    <?php  
				...
				<div class="box-footer">
					...
					<!-- <br><br> -->
					<td><div class="btn-group"><a href="?page=souvenir" class="btn btn-primary pull-left"><i class="fa fa-chevron-left"></i> Back</a> </div>
			...
			<div class="box-body">
					<?php $id=$_GET['id'] ?>
							...
							$hasil=pg_query($querysearch);
							 ...
							 {
							 	?>
										<image src="../../_foto/<?php echo $baris['gallery_souvenir']; ?>" style="width:30%;">
									<?php
							 }
							?>
			</div>
				...
				<div class="btn-group">
					...
					<form role="form" action="act/uploadphotosou.php" enctype="multipart/form-data" method="post">
					  <div class="box-body">
						...
						<span style="color:red;">*Max Size Image 500kb</span>
					  </div><!-- /.box-body -->
