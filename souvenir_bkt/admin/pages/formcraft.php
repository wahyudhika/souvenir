...
<form role="form" action="act/digitindprocess.php" enctype="multipart/form-data" method="post">
...
<!-- 
        ...
        <a href="?page=craft" class="btn btn-primary pull-left"><i class="fa fa-chevron-left"></i> Kembali</a>    
<!-- </form> -->
